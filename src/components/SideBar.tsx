...
function SideBar({ pathname, theme, fold }: IProps) {
  ...
  return (
    <>
      <div className="logo">
        <img
          src={theme ? CitiLogo : CitiLogo_d}
          alt=""
          style={fold ? { marginLeft: "6px", height: "32px" } : {}}
        />
      </div>
      <hr></hr>
      <Menu
      ...
      >
        <Menu.Item key="1">
          <NavLink to="/stock">
            <span
              className="icon"
              style={{ background: firstpathname === "stock" ? color : "" }}
            >
              <svg
                ...
                width="20"
                height="20"
                fill={firstpathname === "stock" ? "white" : "#bfbfbf"}
              >
                <path
        ...
        <Menu.Item key="2">
          <NavLink to="/create">
            <span
              className="icon"
              style={{ background: firstpathname === "create" ? color : "" }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="20"
                height="20"
                fill={firstpathname === "create" ? "white" : "#bfbfbf"}
              >
        ...
        <Menu.Item key="3">
          <NavLink to="/favourites">
            <span
              className="icon"
              style={{
                background: firstpathname === "favourites" ? color : "",
              }}
            >
              <svg
                viewBox="0 0 1024 1024"
                ...
                width="20"
                height="20"
                fill={firstpathname === "favourites" ? "white" : "#bfbfbf"}
              >
                <path
